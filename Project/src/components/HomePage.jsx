...
const HomePage = () => {
  ...
  return (
    <Box sx={{ backgroundColor: darkMode ? "#121212" : '#F2E8CF', minHeight: '100vh' }}>
      <AppBar
        position="fixed"
        sx={{
        ...
        <Container maxWidth="xl">
          <Toolbar disableGutters sx={{ justifyContent: 'space-between' }}>
            <Box sx={{ display: 'flex', alignItems: 'center' }}>
              <LanguageIcon sx={{ display: { xs: "none", md: "flex" }, mr: 1, color: darkMode ? '#fff' : '#F2E8CF' }} />
              <Typography
                variant="h6"
                noWrap
                component="a"
            ...
            <Box sx={{ flexGrow: 1, display: { xs: "none", md: "flex" }, justifyContent: 'center' }}>
              {pages.map((page) => (
                <Button
                  ...
                  sx={{ my: 2, color: darkMode ? '#fff' : '#F2E8CF', display: "block" }}
                >
                  {page}
                </Button>
              ))}
        ...
        <Container maxWidth="lg">
          <Grid container spacing={4} alignItems="center">
            <Grid item xs={12} md={6}>
              <Typography variant="h3" component="h2" gutterBottom sx={{ color: '#F2E8CF', fontFamily: 'fantasy' }}>
                Our Mission
              </Typography>
